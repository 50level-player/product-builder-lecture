...
const menus = {
    korean: [
        { ko: { name: "비빔밥", desc: "고추장과 각종 나물이 어우러진 비빔밥" }, en: { name: "Bibimbap", desc: "Mixed rice with vegetables and spicy sauce" }, ja: { name: "ビビンバ", desc: "野菜とコチュジャンの混ぜご飯" }, icon: "🥗", img: "https://images.unsplash.com/photo-1590301157890-4810ed352733?auto=format&fit=crop&q=80&w=800" },
        { ko: { name: "김치찌개", desc: "얼큰한 한국의 전통 김치찌개" }, en: { name: "Kimchi Jjigae", desc: "Spicy kimchi stew with pork and tofu" }, ja: { name: "キムチチゲ", desc: "ピリ辛の伝統的なキムチチゲ" }, icon: "🥘", img: "https://images.unsplash.com/photo-1583212292454-1fe6229603b7?auto=format&fit=crop&q=80&w=800" },
        { ko: { name: "불고기", desc: "달콤한 양념에 재운 소고기 요리" }, en: { name: "Bulgogi", desc: "Marinated sliced beef barbecue" }, ja: { name: "プルコギ", desc: "甘いタレに漬け込んだ牛肉料理" }, icon: "🍛", img: "https://images.unsplash.com/photo-1662116765994-1e304604f796?auto=format&fit=crop&q=80&w=800" },
        { ko: { name: "떡볶이", desc: "매콤달콤한 국민 간식 떡볶이" }, en: { name: "Tteokbokki", desc: "Spicy stirred rice cakes" }, ja: { name: "トッポギ", desc: "甘辛い韓国の国民的人気おやつ" }, icon: "🌶️", img: "https://images.unsplash.com/photo-1498654896293-37aacf113fd9?auto=format&fit=crop&q=80&w=800" },
        { ko: { name: "삼겹살", desc: "지글지글 구워먹는 돼지 삼겹살" }, en: { name: "Samgyeopsal", desc: "Grilled pork belly barbecue" }, ja: { name: "サムギョプサル", desc: "ジューシーに焼いた豚の三枚肉" }, icon: "🥓", img: "https://images.unsplash.com/photo-1533777324545-e0162727fc90?auto=format&fit=crop&q=80&w=800" },
        ...
        { ko: { name: "갈비찜", desc: "부드럽고 달콤한 소갈비 찜" }, en: { name: "Galbi-jjim", desc: "Braised beef short ribs" }, ja: { name: "カルビチム", desc: "柔らかく煮込んだ牛カルビ" }, icon: "🍖", img: "https://images.unsplash.com/photo-1604382354936-07c5d9983bd3?auto=format&fit=crop&q=80&w=800" },
        { ko: { name: "냉면", desc: "시원한 육수의 평양식 물냉면" }, en: { name: "Naengmyeon", desc: "Cold buckwheat noodles" }, ja: { name: "冷麺", desc: "ひんやりスープの韓国冷麺" }, icon: "❄️", img: "https://images.unsplash.com/photo-1547592166-23ac45744acd?auto=format&fit=crop&q=80&w=800" },
        { ko: { name: "김밥", desc: "간편하고 맛있는 국민 도시락 김밥" }, en: { name: "Kimbap", desc: "Korean seaweed rice rolls" }, ja: { name: "キンパ", desc: "海苔で巻いた韓国風海苔巻き" }, icon: "🍱", img: "https://images.unsplash.com/photo-1590301157890-4810ed352733?auto=format&fit=crop&q=80&w=800" },
        ...
        { ko: { name: "닭갈비", desc: "매콤한 양념의 춘천식 닭갈비" }, en: { name: "Dak-galbi", desc: "Spicy stir-fried chicken" }, ja: { name: "タッカルビ", desc: "ピリ辛タレの鶏肉炒め" }, icon: "🥘", img: "https://images.unsplash.com/photo-1498654896293-37aacf113fd9?auto=format&fit=crop&q=80&w=800" },
        { ko: { name: "만두", desc: "속이 꽉 찬 고소한 고기 만두" }, en: { name: "Mandu", desc: "Korean dumplings" }, ja: { name: "マンドゥ", desc: "具沢山の韓国風餃子" }, icon: "🥟", img: "https://images.unsplash.com/photo-1541696432-82c6da8ce7bf?auto=format&fit=crop&q=80&w=800" },
        ...
        { ko: { name: "보쌈", desc: "담백하게 삶아낸 돼지고기 수육" }, en: { name: "Bossam", desc: "Boiled pork wraps" }, ja: { name: "ポッサム", desc: "茹でた豚肉の包み料理" }, icon: "🥬", img: "https://images.unsplash.com/photo-1533777324545-e0162727fc90?auto=format&fit=crop&q=80&w=800" },
        { ko: { name: "국밥", desc: "뜨끈한 국물에 밥을 만 국밥" }, en: { name: "Gukbap", desc: "Rice in hot soup" }, ja: { name: "クッパ", desc: "温かいスープご飯" }, icon: "🥣", img: "https://images.unsplash.com/photo-1644600120462-97be23e980f7?auto=format&fit=crop&q=80&w=800" },
        ...
        { ko: { name: "파전", desc: "쪽파를 듬뿍 넣은 고소한 전" }, en: { name: "Pajeon", desc: "Green onion pancake" }, ja: { name: "パジョン", desc: "ネギのチヂミ" }, icon: "🥞", img: "https://images.unsplash.com/photo-1616669944447-d65be4cc94e0?auto=format&fit=crop&q=80&w=800" }
    ],
    western: [
        { ko: { name: "립아이 스테이크", desc: "육즙 가득한 프리미엄 스테이크" }, en: { name: "Ribeye Steak", desc: "Juicy premium steak" }, ja: { name: "リブアイステーキ", desc: "肉汁たっぷりのステーキ" }, icon: "🥩", img: "https://images.unsplash.com/photo-1546833999-b9f581a1996d?auto=format&fit=crop&q=80&w=800" },
        ...
        { ko: { name: "마르게리타 피자", desc: "신선한 토마토와 바질의 피자" }, en: { name: "Pizza Margherita", desc: "Tomato and basil pizza" }, ja: { name: "マルゲリータ", desc: "トマトとバジルのピザ" }, icon: "🍕", img: "https://images.unsplash.com/photo-1604382354936-07c5d9983bd3?auto=format&fit=crop&q=80&w=800" },
        ...
        { ko: { name: "클램 차우더", desc: "부드럽고 고소한 조개 스프" }, en: { name: "Clam Chowder", desc: "Creamy clam soup" }, ja: { name: "クラムチャウダー", desc: "クリーミーな貝のスープ" }, icon: "🥣", img: "https://images.unsplash.com/photo-1545093149-618ce3bcf49d?auto=format&fit=crop&q=80&w=800" },
        ...
        { ko: { name: "셰퍼드 파이", desc: "영국식 고기와 감자 파이" }, en: { name: "Shepherd's Pie", desc: "British meat and potato pie" }, ja: { name: "シェパードパイ", desc: "肉とポテトのイギリス風パイ" }, icon: "🥧", img: "https://images.unsplash.com/photo-1547592166-23ac45744acd?auto=format&fit=crop&q=80&w=800" },
    ...
    japanese: [
        ...
        { ko: { name: "소바", desc: "구수한 메밀 국수 요리" }, en: { name: "Soba", desc: "Japanese buckwheat noodles" }, ja: { name: "そば", desc: "香ばしい蕎麦料理" }, icon: "🍜", img: "https://images.unsplash.com/photo-1513104890138-7c749659a591?auto=format&fit=crop&q=80&w=800" },
        ...
        { ko: { name: "오니기리", desc: "간편하게 즐기는 주먹밥" }, en: { name: "Onigiri", desc: "Japanese rice balls" }, ja: { name: "おにぎり", desc: "手軽に食べられるおむすび" }, icon: "🍙", img: "https://images.unsplash.com/photo-1534422298391-e4f8c170db06?auto=format&fit=crop&q=80&w=800" },
        { ko: { name: "카레라이스", desc: "일본식 진한 카레 요리" }, en: { name: "Curry Rice", desc: "Japanese style curry" }, ja: { name: "カレーライス", desc: "日本風の濃厚なカレー" }, icon: "🍛", img: "https://images.unsplash.com/photo-1604382354936-07c5d9983bd3?auto=format&fit=crop&q=80&w=800" },
        ...
        { ko: { name: "오뎅", desc: "따뜻한 국물의 모둠 어묵" }, en: { name: "Oden", desc: "Hot assorted fish cakes" }, ja: { name: "おでん", desc: "温かいおでん盛り合わせ" }, icon: "🍢", img: "https://images.unsplash.com/photo-1558985250-27a406d64cb3?auto=format&fit=crop&q=80&w=800" },
        { ko: { name: "스키야키", desc: "달콤한 간장 소스의 소고기 전골" }, en: { name: "Sukiyaki", desc: "Sweet soy beef hot pot" }, ja: { name: "すき焼き", desc: "甘い醤油タレの牛肉鍋" }, icon: "🍲", img: "https://images.unsplash.com/photo-1547592166-23ac45744acd?auto=format&fit=crop&q=80&w=800" },
        { ko: { name: "가이세키", desc: "화려한 일본 정식 요리" }, en: { name: "Kaiseki", desc: "Multi-course Japanese dinner" }, ja: { name: "懐石料理", desc: "華やかな日本のコース料理" }, icon: "🍱", img: "https://images.unsplash.com/photo-1579871494447-9811cf80d66c?auto=format&fit=crop&q=80&w=800" },
        { ko: { name: "오무라이스", desc: "폭신한 계란의 볶음밥" }, en: { name: "Omurice", desc: "Omelet over fried rice" }, ja: { name: "オムライス", desc: "ふわふわ卵のオムライス" }, icon: "🍳", img: "https://images.unsplash.com/photo-1608039829572-78524f79c4c7?auto=format&fit=crop&q=80&w=800" }
    ]
};
